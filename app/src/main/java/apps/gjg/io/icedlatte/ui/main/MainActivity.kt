...
import kotlinx.android.synthetic.main.coffee_state_fragment.view.*
...
class CoffeeControlFragment : Fragment() {
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val inflate = inflater?.inflate(R.layout.coffee_control_fragment, container, false)
        inflate?.gridviewState?.adapter = CoffeeButtonAdapter(activity)
        return inflate
    }
}
...
class CoffeeStateFragment : Fragment() {
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val inflate = inflater?.inflate(R.layout.coffee_state_fragment, container, false)
        inflate?.gridviewState?.adapter = CoffeeButtonAdapter(activity)
        return inflate
    }
}
